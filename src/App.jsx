...
function Button({ href, children, variant = 'primary', className = '' }) {
  const base =
    'group inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 font-black transition-all duration-300 hover:-translate-y-1 hover:scale-105'
...
{mobileMenu && (
  ...
  <span className="whitespace-nowrap">
    中國貨回台｜網購集運｜倉儲服務
            ...
            <Button
  href="#quote"
  className="min-w-[260px] justify-center rounded-[32px] px-16 py-7 text-2xl font-black"
>
  線上詢價
</Button>
...
>
  關於尚順
      ...
      <section id="why-us" className="relative bg-gradient-to-br from-blue-900 via-cyan-900 to-sky-800 py-20 text-white md:py-24">
