...
function SectionTitle({ eyebrow, title, desc, dark = false }) {
  return (
    <div className="mb-10 w-full max-w-7xl">
      ...
      {desc && (
        <p className={`mt-4 max-w-6xl leading-8 ${dark ? 'text-cyan-50/85' : 'text-slate-600'}`}>
          {desc}
        </p>
      )}
    </div>
...
function Card({ title, desc, Icon, dark = false }) {
  const cardClass = dark
    ? 'border-white/10 bg-white/[.07] text-white hover:border-cyan-300/70 hover:bg-cyan-300/[.08]'
...
function App() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section id="home" className="relative pt-24 pb-32 md:min-h-screen md:pt-28 md:pb-24">
      ...
      <section id="keywords" className="bg-white py-20 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="shopping" className="bg-slate-50 py-20 text-slate-900">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {shoppingItems.map(([title, desc]) => (
              <div key={title} className="rounded-3xl border border-slate-200 bg-white p-6 text-slate-900 shadow-card">
      ...
      <section id="services" className="bg-white py-20 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="special" className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-20 text-white">
        <div className="mx-auto max-w-7xl px-5">
      ...
      <section id="process" className="bg-white py-20 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section className="relative bg-slate-50 py-20 text-slate-900">
      ...
      <section id="faq" className="bg-white py-20 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="quote" className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-20 text-white">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <div className="rounded-3xl border border-cyan-300/20 bg-white/10 p-6 text-center shadow-card backdrop-blur">
      ...
      <section id="contact" className="bg-white py-20 text-slate-900"><div className="mx-auto max-w-7xl px-5">
