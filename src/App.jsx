...
function Card({ title, desc, Icon }) {
  return (
    <div className="group rounded-3xl border border-white/10 bg-slate-900/55 backdrop-blur-md p-6 shadow-card transition-all duration-300 hover:-translate-y-2 hover:border-cyan-300/70 hover:bg-cyan-300/[.08] hover:shadow-[0_0_45px_rgba(34,211,238,.35)]">
      <Icon
...
function App() {
  return (
    <div
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(2,6,23,.84), rgba(2,6,23,.92)), url('/global-logistics.png')",
    ...
    >
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-slate-900/55 backdrop-blur-xl">
      ...
      <section id="home" className="relative pt-24 pb-32 md:min-h-screen md:pt-28 md:pb-24">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.08fr_.92fr]">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/10 p-5 shadow-card backdrop-blur-xl">
            <div className="rounded-[1.5rem] bg-slate-900/55 p-6">
      ...
      <section id="shopping" className="bg-slate-950/45 py-20 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {shoppingItems.map(([title, desc]) => (
              <div key={title} className="rounded-3xl border border-white/10 bg-slate-900/55 p-6 shadow-card">
          ...
          <div className="mt-8 rounded-3xl border border-cyan-300/20 bg-cyan-300/10 p-6">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-4">
              {['提供商品資訊', '賣家寄至集貨倉', '確認件數尺寸重量', '安排合併回台'].map((step, i) => (
                <div key={step} className="rounded-2xl bg-slate-900/55 p-5">
      ...
      <section id="special" className="bg-slate-950/45 py-20 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-5">
          <SectionTitle eyebrow="SPECIAL CARGO" title="特殊貨物也可協助評估" desc="化工品、敏感貨、電池、大型家具與大型機具，請提供完整產品資料及照片，我司協助評估合適方案。" />
          <div className="grid gap-4 md:grid-cols-5">
            {special.map(item => (
              <div key={item} className="rounded-2xl border border-cyan-300/20 bg-slate-900/55 p-5 text-center font-black">
                ✔ {item}
              </div>
            ))}
          </div>
      ...
      <section id="process" className="mx-auto max-w-7xl px-5 py-20">
        ...
        <div className="grid gap-4 md:grid-cols-6">
          {steps.map((step, i) => (
            <div key={step} className="rounded-3xl border border-white/10 bg-slate-900/55 backdrop-blur-md p-5">
      ...
      <section className="relative bg-slate-950/45 py-20 backdrop-blur-sm">
        <div className="relative mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-2">
          <div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {reasons.map(item => <div key={item} className="flex items-center gap-3 rounded-2xl bg-slate-900/55 backdrop-blur-md p-4"><CheckCircle2 className="text-cyan-300" size={20}/>{item}</div>)}
            </div>
          </div>
          <div>
      ...
      <section id="faq" className="mx-auto max-w-7xl px-5 py-20">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {faqs.map(([q, a]) => (
            <div key={q} className="rounded-3xl border border-white/10 bg-slate-900/55 backdrop-blur-md p-6">
      ...
      <section id="quote" className="bg-slate-950/45 py-20 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <div className="rounded-3xl border border-cyan-300/20 bg-slate-900/55 p-6 text-center shadow-card">
      ...
      <section id="contact" className="mx-auto max-w-7xl px-5 py-20">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-slate-900/55 backdrop-blur-md p-6">
