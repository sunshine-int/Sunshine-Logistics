...
function App() {
  ...
  target="_blank"
  rel="noreferrer"
  className="hidden sm:inline-flex items-center gap-2 rounded-full bg-[#06C755] px-6 py-3 text-sm font-black text-white transition-all duration-300 hover:bg-[#05b84d] hover:scale-105"
>
