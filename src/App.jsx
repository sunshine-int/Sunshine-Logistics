...
function App() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section id="keywords" className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-20 text-white md:py-24"><div className="mx-auto max-w-7xl px-5">
