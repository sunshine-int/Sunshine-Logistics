...
function App() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <section id="keywords" className="bg-white py-24 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="shopping" className="bg-slate-50 py-24 text-slate-900">
      ...
      <section id="services" className="bg-white py-24 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="special" className="bg-gradient-to-r from-slate-950 via-blue-950 to-slate-900 py-24 text-white">
        <div className="mx-auto max-w-7xl px-5">
      ...
      <section id="process" className="bg-white py-24 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-cyan-50 to-white py-24 text-slate-900">
      ...
      <section id="faq" className="bg-white py-24 text-slate-900"><div className="mx-auto max-w-7xl px-5">
      ...
      <section id="quote" className="bg-gradient-to-br from-slate-950 via-blue-900 to-cyan-900 py-24 text-white">
        <div className="mx-auto max-w-7xl px-5">
