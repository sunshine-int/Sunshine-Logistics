  ...
  進度清楚掌握
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
              {processSteps.map((item, index) => (
                <div
                  key={item.title}
                  className="rounded-[1.6rem] border border-cyan-300/20 bg-[#0f2747]/75 p-6 shadow-xl backdrop-blur"
                >
                  <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-white text-lg font-black text-[#071426]">
                    {index + 1}
                  </div>
