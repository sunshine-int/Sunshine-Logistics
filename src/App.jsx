...
import {
  ...
  CheckCircle2, ArrowRight, ShieldCheck, Facebook, MessageCircle,
          ...
          <div className="section">
            <div className="contact-box">
              ...
              <div className="contact-grid">
                ...
                <a className="social-card fb" href={companyInfo.facebook} target="_blank" rel="noreferrer"><Facebook size={22} />Facebook 粉絲專頁</a>
