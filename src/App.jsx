...
const navItems = [
  ...
  { label: "小三通", path: "/cross-strait" },
  { label: "海運服務", path: "/sea-freight" },
  { label: "空運服務", path: "/air-freight" },
  { label: "物流流程", path: "/process" },
  { label: "常見問題", path: "/faq" },
  { label: "聯絡我們", path: "/contact" },
  { label: "線上詢價", path: "/quote" },
];
    ...
    <header className="header">
      <div className="header-inner">
        ...
        <div className="header-actions">
          <LinkButton to="/quote" className="header-cta">立即詢價</LinkButton>
