    ...
    <div className="site">
      <style>{`
        * { box-sizing: border-box; }
        ...
        @keyframes routeGlow {
          50% { opacity: .45; filter: drop-shadow(0 0 12px #93c5fd); }
        }
          ...
          <div className="hero-inner">
            <div>
              ...
              <h1>
                尚順國際運通
                <span>
                  <span className="mobile-title">全球物流</span>
                  <span className="mobile-title">專業運輸</span>
                  <span className="mobile-title">值得信賴</span>
                </span>
              </h1>
              ...
              <div className="hero-actions">
                ...
                <a className="btn-secondary" href={companyInfo.line} target="_blank" rel="noreferrer">
                  LINE 加我好友 <MessageCircle size={18} />
                </a>
              </div>
            </div>
