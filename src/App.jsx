...
function App() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950/30 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.08fr_.92fr]">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              ...
              <Button href={`tel:${company.phone}`} variant="secondary" className="w-full sm:w-auto">
                <Phone size={18} />
                04-22529955
              </Button>
            </div>
      ...
      <a href={company.line} target="_blank" rel="noreferrer" className="fixed bottom-24 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-cyan-300 px-5 py-4 text-sm font-black text-slate-950 shadow-glow">
