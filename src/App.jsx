  ...
  return (
    <div className="min-h-screen text-white bg-[#061427]">
      ...
      <section className={`relative py-24 px-6 ${sectionBg}`}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="mb-16">
            <p className="text-blue-500 font-bold mb-4 tracking-widest">
              公司優勢
            </p>

            <h3 className="text-5xl md:text-7xl font-black leading-tight text-[#102544]">
              跨境物流
              <br />
              專業整合方案
            </h3>

            <p className="mt-8 text-xl leading-loose text-slate-600 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <h4 className="text-2xl font-black text-[#102544] mb-4">
                  {item.title}
                </h4>
      ...
      <section id="route" className={`relative py-24 px-6 ${sectionBg}`}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <h3 className="text-4xl font-bold mb-8">全球物流路線</h3>
