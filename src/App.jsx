...
const aboutAdvantages = [
  ['專業物流經驗', '深耕兩岸物流多年，熟悉中國、台灣及東南亞市場，提供完整物流規劃服務。', Ship],
  ['運輸方式多元', '海運、海快、空運、小三通、特貨運輸，依需求規劃最適方案。', Plane],
  ['報關清關服務', '協助進出口報關、文件審核與清關作業，降低貨物延誤風險。', SearchCheck],
  ['倉儲整合管理', '提供集貨、入倉、理貨、合併出貨服務，提升物流效率。', Warehouse],
  ['全程貨況追蹤', '貨物進度透明化，即時掌握物流動態，讓出貨更安心。', PackageCheck],
  ['客製化物流方案', '依產品特性與需求，提供專屬運輸規劃，降低成本與風險。', ShieldCheck],
  ['特殊貨物運輸', '化工品、電池、大型家具、大型機具，協助評估最佳運輸方式。', Truck],
  ['全球物流服務', '中國、台灣、日本、東南亞及全球物流運輸，一站式整合服務。', Globe2],
]
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-slate-950/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 md:px-5 md:py-4">
          <a href="#home" className="flex min-w-0 items-center gap-3 md:gap-4">
            ...
            />
            <div>
              <p className="text-sm font-black leading-tight tracking-wide text-white sm:text-base md:text-xl">
                尚順國際運通有限公司
              </p>
      ...
      <section id="about" className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-20 text-white md:py-24">
        <div className="mx-auto max-w-7xl px-5">
          <SectionTitle
            ...
            title="關於尚順國際運通"
            desc="尚順國際運通深耕兩岸與國際物流多年，專注於中國貨回台、小三通物流、茶葉小三通、淘寶／拼多多／1688集運回台、東南亞進出口及全球物流服務。我們的核心不是低價，而是穩定、安全、清楚，讓每一位客戶都能掌握貨物進度，降低物流風險，提高運輸效率。"
          />
