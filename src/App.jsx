  ...
  return (
    <section className="section">
      <div className="section-title">
        ...
        <h2 dangerouslySetInnerHTML={{ __html: "我們的核心不是低價，<br />而是穩定、安全、清楚" }} />
  ...
  return (
    <style>{`
      *{box-sizing:border-box}
      ...
      body{margin:0;font-family:"Noto Sans TC","Microsoft JhengHei",Arial,sans-serif;color:#082f5b;background:#f4f7fb}
